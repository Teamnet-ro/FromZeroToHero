			...
			<div class="span12">
				...
				<form class="form-horizontal" method="post" action="<c:url value="/admin/save/" />" name="employeeForm" id="employeeForm">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="firstName" id="firstName" title="First Name" value="${employee.firstName}">
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">Prenume</label>
						<div class="controls">
							<input type="text" name="lastName" id="lastName" title="Last Name" value="${employee.lastName}">
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">Email</label>
						<div class="controls">
							<input type="text" name="email" id="email" title="Email" value="${employee.email}">
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">Password</label>
						<div class="controls">
							<input type="password" name="password" id="password" title="Password" value="${employee.password}">
						</div>
					</div>
					<input type="hidden" name="employeeId" id="employeeId" title="employeeId" value="${employee.employeeId}">
